...
<p><strong>What are the customer pre-requisites?</strong><br />&bull; Customer Portal SDK StreamOne License Terms/>&bull; Partner API credentials<br />&bull; Azure account<br />&bull; Azure CSP subscription<br />&bull; Microsoft account for login<br />&bull; Partner resources to maintain it on Azure <br />&bull; Estimate monthly cost ~USD18.00 (List Price, VAT Excluded)<br /> App Service, Tier Shared, D1, 1 GM RAM, 1 GB  Storage<br /> Azure SQL DB Single Database, Basic Tier. 5 DTUs, 2, 2 GM </p>
